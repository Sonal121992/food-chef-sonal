...
function Popular() {
    ...
    const getPopular = async() => {
            const api = await fetch(`https://api.edamam.com/api/recipes/v2?type=public&q=random&app_id=${process.env.REACT_APP_EDAMAM_APP_ID}&app_key=${process.env.REACT_APP_EDAMAM_APP_KEY}&from=0&to=9&random=true`);
