...
function Veggie() {
    ...
    const getVeggie = async() => {
            const api = await fetch(`https://api.edamam.com/api/recipes/v2/?type=public&app_id=${process.env.REACT_APP_EDAMAM_APP_ID}&app_key=${process.env.REACT_APP_EDAMAM_APP_KEY}&health=vegetarian&from=0&to=9`);
